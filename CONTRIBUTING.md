...
2. [Branching Guidelines](#branching-guidelines)
...
1. **Find an Issue**  
   Go to the [Issues](https://github.com/AbdulMoeez1278/moizy-open-source-issues/issues) tab and pick an open issue that interests you.
